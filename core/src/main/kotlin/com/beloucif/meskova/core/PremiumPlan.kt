 ...
 * Technical id created under the product's former name (before the Meskova rebrand) -
 * do NOT rename without migrating the entitlement in the RevenueCat dashboard, or
 * existing subscribers lose access. The app's display name is "Meskova" everywhere
