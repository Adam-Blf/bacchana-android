 ...
 * Renamed to "La Tournee Pro" (no accent, exact RevenueCat dashboard id) for the product's
 * fifth name, La Tournee (display: "La Tournée"). The app is not yet published, so there are
 ...
 */
const val PREMIUM_ENTITLEMENT_ID = "La Tournee Pro"
