 ...
 * Renamed to "Bacchus Pro" (no accent, exact RevenueCat dashboard id) for the product's
 * fifth name, Bacchus (display: "Bacchus"). The app is not yet published, so there are
 ...
 */
const val PREMIUM_ENTITLEMENT_ID = "Bacchus Pro"
