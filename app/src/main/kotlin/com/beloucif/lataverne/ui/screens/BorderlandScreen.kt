...
import com.beloucif.lataverne.core.BorderlandState
import com.beloucif.lataverne.core.Card
import com.beloucif.lataverne.core.GamePhase
import com.beloucif.lataverne.core.Player
import com.beloucif.lataverne.core.Suit
...
private fun PlayingCard(card: Card, revealed: Boolean, onClick: () -> Unit) {
    Box(
        modifier = Modifier
            ...
            .aspectRatio(0.7f)
            .background(
                if (revealed) LaTaverneColors.CardFace else LaTaverneColors.Surface,
