...
import com.beloucif.bacchana.core.BorderlandState
import com.beloucif.bacchana.core.Card
import com.beloucif.bacchana.core.GamePhase
import com.beloucif.bacchana.core.Player
import com.beloucif.bacchana.core.Suit
import com.beloucif.bacchana.ui.BorderlandViewModel
...
private fun PlayingCard(card: Card, revealed: Boolean, onClick: () -> Unit) {
    Box(
        modifier = Modifier
            ...
            .aspectRatio(0.7f)
            .background(
                if (revealed) BacchanaColors.CardFace else BacchanaColors.Surface,
