                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                        Row(
                            ...
                            Text(
                                ...
                                style = MaterialTheme.typography.labelSmall,
                                color = if (isPremium) BacchanaColors.Premium else BacchanaColors.InkSecondary,
                            )
                        }
                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                        Row(
                            ...
                            Switch(
                                ...
                                colors = SwitchDefaults.colors(checkedThumbColor = BacchanaColors.Neon),
                            )
                        }
                        ...
                        TextButton(
                            ...
                            Text(stringResource(R.string.settings_privacy_policy), color = BacchanaColors.InkSecondary)
                        }
                    }
                }
            }
            ...
            item {
                SettingsSection(title = stringResource(R.string.settings_section_legal)) {
                    TextButton(
                        ...
                        Text(stringResource(R.string.settings_legal_link), color = BacchanaColors.InkSecondary)
                    }
                }
            }
        ...
        AlertDialog(
            ...
            confirmButton = {
                TextButton(onClick = {
                    ...
                    Text(stringResource(R.string.settings_reset_dialog_confirm), color = BacchanaColors.CardRed)
                }
            },
            dismissButton = {
...
private const val LEGAL_URL = "https://bacchana.beloucif.com"
