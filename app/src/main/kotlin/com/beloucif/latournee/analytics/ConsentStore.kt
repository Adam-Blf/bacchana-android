...
// Renamed from "meskova_consent": app never published, no installs to migrate (see CHANGELOG).
private val Context.consentDataStore by preferencesDataStore(name = "latournee_consent")
