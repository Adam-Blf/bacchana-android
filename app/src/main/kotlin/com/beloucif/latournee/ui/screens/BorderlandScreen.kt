...
import com.beloucif.latournee.core.BorderlandState
import com.beloucif.latournee.core.Card
import com.beloucif.latournee.core.GamePhase
import com.beloucif.latournee.core.Player
import com.beloucif.latournee.core.Suit
import com.beloucif.latournee.ui.BorderlandViewModel
...
private fun PlayingCard(card: Card, revealed: Boolean, onClick: () -> Unit) {
    Box(
        modifier = Modifier
            ...
            .aspectRatio(0.7f)
            .background(
                if (revealed) LaTourneeColors.CardFace else LaTourneeColors.Surface,
