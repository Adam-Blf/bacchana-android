                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                        Row(
                            ...
                            Text(
                                ...
                                style = MaterialTheme.typography.labelSmall,
                                color = if (isPremium) LaTourneeColors.Premium else LaTourneeColors.InkSecondary,
                            )
                        }
                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                        Row(
                            ...
                            Switch(
                                ...
                                colors = SwitchDefaults.colors(checkedThumbColor = LaTourneeColors.Neon),
                            )
                        }
                        ...
                        TextButton(
                            ...
                            Text(stringResource(R.string.settings_privacy_policy), color = LaTourneeColors.InkSecondary)
                        }
                    }
                }
            }
            ...
            item {
                SettingsSection(title = stringResource(R.string.settings_section_legal)) {
                    TextButton(
                        ...
                        Text(stringResource(R.string.settings_legal_link), color = LaTourneeColors.InkSecondary)
                    }
                }
            }
        ...
        AlertDialog(
            ...
            confirmButton = {
                TextButton(onClick = {
                    ...
                    Text(stringResource(R.string.settings_reset_dialog_confirm), color = LaTourneeColors.CardRed)
                }
            },
            dismissButton = {
 ...
 */
private const val PRIVACY_POLICY_URL = "https://latournee.beloucif.com"
private const val LEGAL_URL = "https://latournee.beloucif.com"
