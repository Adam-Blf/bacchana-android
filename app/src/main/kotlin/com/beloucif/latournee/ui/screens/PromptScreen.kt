...
import com.beloucif.latournee.ui.PromptUiState
import com.beloucif.latournee.ui.PromptViewModel
    ...
    Column(
                ...
                is PromptUiState.Ready -> Column {
                    ...
                    targetLabel(state.targetPlayers)?.let { label ->
                        Text(
                            ...
                            color = LaTourneeColors.OrangeInk,
        ...
        Row(
            ...
            Button(
                ...
                modifier = Modifier
                    .weight(1f)
                    .background(LaTourneeColors.NeonDeep, RoundedCornerShape(16.dp)),
            ) {
