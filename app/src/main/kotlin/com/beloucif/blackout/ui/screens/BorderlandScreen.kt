...
import com.beloucif.blackout.core.BorderlandState
import com.beloucif.blackout.core.Card
import com.beloucif.blackout.core.GamePhase
import com.beloucif.blackout.core.Player
import com.beloucif.blackout.core.Suit
import com.beloucif.blackout.ui.BorderlandViewModel
...
private fun PlayingCard(card: Card, revealed: Boolean, onClick: () -> Unit) {
    Box(
        modifier = Modifier
            ...
            .aspectRatio(0.7f)
            .background(
                if (revealed) BlackOutColors.CardFace else BlackOutColors.Surface,
        ...
        if (revealed) {
            val pipColor = if (card.suit == Suit.HEARTS || card.suit == Suit.DIAMONDS) {
                BlackOutColors.CardRed
            } else {
                BlackOutColors.CardInk
            }
            Text(
