                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                        Row(
                            ...
                            Text(
                                ...
                                style = MaterialTheme.typography.labelSmall,
                                color = if (isPremium) MeskovaColors.Premium else MeskovaColors.InkSecondary,
                            )
                        }
                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                        Row(
                            ...
                            Switch(
                                ...
                                colors = SwitchDefaults.colors(checkedThumbColor = MeskovaColors.Neon),
                            )
                        }
                        ...
                        TextButton(
                            ...
                            Text(stringResource(R.string.settings_privacy_policy), color = MeskovaColors.InkSecondary)
                        }
                    }
                }
            }
            ...
            item {
                SettingsSection(title = stringResource(R.string.settings_section_legal)) {
                    TextButton(
                        ...
                        Text(stringResource(R.string.settings_legal_link), color = MeskovaColors.InkSecondary)
                    }
                }
            }
        ...
        AlertDialog(
            ...
            confirmButton = {
                TextButton(onClick = {
                    ...
                    Text(stringResource(R.string.settings_reset_dialog_confirm), color = MeskovaColors.CardRed)
                }
            },
            dismissButton = {
