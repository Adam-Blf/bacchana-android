                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                        Row(
                            ...
                            Text(
                                ...
                                style = MaterialTheme.typography.labelSmall,
                                color = if (isPremium) BacchusColors.Premium else BacchusColors.InkSecondary,
                            )
                        }
                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                        Row(
                            ...
                            Switch(
                                ...
                                colors = SwitchDefaults.colors(checkedThumbColor = BacchusColors.Neon),
                            )
                        }
                        ...
                        TextButton(
                            ...
                            Text(stringResource(R.string.settings_privacy_policy), color = BacchusColors.InkSecondary)
                        }
                    }
                }
            }
            ...
            item {
                SettingsSection(title = stringResource(R.string.settings_section_legal)) {
                    TextButton(
                        ...
                        Text(stringResource(R.string.settings_legal_link), color = BacchusColors.InkSecondary)
                    }
                }
            }
        ...
        AlertDialog(
            ...
            confirmButton = {
                TextButton(onClick = {
                    ...
                    Text(stringResource(R.string.settings_reset_dialog_confirm), color = BacchusColors.CardRed)
                }
            },
            dismissButton = {
 ...
 */
private const val PRIVACY_POLICY_URL = "https://bacchus.beloucif.com"
private const val LEGAL_URL = "https://bacchus.beloucif.com"
