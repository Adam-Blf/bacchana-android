# Publication La Tournée Android
...
- Créer l'application avec le bundle ID `com.beloucif.latournee`
...
keytool -genkey -v -keystore latournee-release.jks ^
...
$keystore = Get-Content -Path "chemin/vers/latournee-release.jks" -Encoding Byte
$base64 = [Convert]::ToBase64String($keystore)
$base64 | Set-Content -Path "keystore-base64.txt"

# Ou sur Git Bash :
cat chemin/vers/latournee-release.jks | base64 > keystore-base64.txt
...
gh secret set ANDROID_KEY_ALIAS --body "latournee"
