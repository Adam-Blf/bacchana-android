# Publication La Taverne Android
...
- Créer l'application avec le bundle ID `com.beloucif.lataverne`
...
keytool -genkey -v -keystore lataverne-release.jks ^
...
$keystore = Get-Content -Path "chemin/vers/lataverne-release.jks" -Encoding Byte
$base64 = [Convert]::ToBase64String($keystore)
$base64 | Set-Content -Path "keystore-base64.txt"

# Ou sur Git Bash :
cat chemin/vers/lataverne-release.jks | base64 > keystore-base64.txt
...
gh secret set ANDROID_KEY_ALIAS --body "lataverne"
