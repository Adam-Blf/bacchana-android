...
IGNORES = {"build", ".gradle", ".git", ".claude", ".idea", "node_modules"}
...
FICHIERS_EXEMPTES = {
    # Ce test verifie precisement qu'aucun libelle de penalite ne contient ces
    # mots. Il doit donc pouvoir les ecrire, exactement comme cette garde.
    "core/src/test/kotlin/com/beloucif/bacchana/core/ContestTest.kt",
    # Ces deux fichiers DECRIVENT le dessin de l'icone - « deux verres qui
    # trinquent ». Le commentaire est exact, et le reecrire ne changerait pas le
    # dessin : c'est l'ICONE qui pose question au regard d'Apple 1.4.3, pas sa
    # description. Le masquer ferait perdre la trace de ce qu'il faut redessiner.
